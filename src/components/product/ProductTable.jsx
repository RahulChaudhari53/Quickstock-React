...
export default function ProductTable({
  ...
  // Helper component for the status badge to avoid repetition
  ...
  return (
    <div className="rounded-lg">
          ...
          <tbody className="bg-gray-800 divide-y divide-gray-700">
            {products.map((product) => (
              <tr key={product._id} className="hover:bg-gray-700/50">
                <td className="px-6 py-4 whitespace-normal max-w-xs text-sm font-medium text-white">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                  <div>Sell: ${product.sellingPrice.toFixed(2)}</div>
      ...
      {/* --- MOBILE CARD VIEW (screens smaller than md) --- */}
      <div className="md:hidden space-y-4">
        {products.map((product) => (
          ...
          >
            ...
            <div className="space-y-3 text-sm border-t border-gray-600 pt-3">
