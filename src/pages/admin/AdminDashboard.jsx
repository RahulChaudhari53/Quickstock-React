...
export default function AdminDashboard() {
  ...
  if (isLoading) {
    return (
      <div className="text-white text-xl flex justify-center items-center min-h-[50vh]">
        Loading users...
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="text-red-400 text-xl flex justify-center items-center min-h-[50vh]">
